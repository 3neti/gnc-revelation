...
it('evaluates RDG borrower qualification using PurchasePlanCalculator', function (
    ...
    $result = $calc->getQualificationResult(Money::of($grossIncome * $multiplier, 'PHP'));
